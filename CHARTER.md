...
Helpthread is an independent implementation. The repository contains no code copied or derived from any copyleft-licensed project. Dependencies and study references are permissively licensed, with each license verified at adoption. Behavior is specified and validated against public standards, public documentation, and black-box testing of running systems. Every substantive change receives real human design and review before merge — ordinary pull-request review, preserved in git history — which is also what keeps AI-assisted work firmly copyrightable, and therefore dual-licensable, under current U.S. Copyright Office guidance.
