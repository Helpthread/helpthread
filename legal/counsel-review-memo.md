...
Until they exist, §8's incorporations-by-reference are forward references — flagged so
counsel drafts them with these obligations in view: 14-day refund window, 7-day
config-export grace, immediate decommission on revocation only (all per
`specs/modules/marketplace-v1.md` §10 resolutions, TJ 2026-07-19).
