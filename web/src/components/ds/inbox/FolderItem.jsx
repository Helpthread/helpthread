  ...
  return (
    <button type="button" onClick={onClick}
      style={{ display: "flex", alignItems: "center", gap: 10, width: "100%", boxSizing: "border-box",
        textAlign: "left", fontSize: 12, fontWeight: active ? 700 : 400, color: fg,
        background: active ? "var(--ht-accent-soft)" : "transparent", border: "none",
        borderRadius: "var(--ht-radius-sm)", padding: "8px 10px", cursor: "pointer" }}
      ...
      <span style={{ fontSize: 10.5, fontWeight: 600, fontVariantNumeric: "tabular-nums",
        color: active ? "var(--ht-accent)" : "var(--ht-ink-muted)" }}>{count}</span>
    </button>
  );
}
