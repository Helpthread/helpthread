...
export function Toast({ message, detail, fixed = false, style }) {
  return (
    <div style={{ ...(fixed ? { position: "fixed", right: 20, bottom: 20, zIndex: 70 } : {}), maxWidth: 340,
      background: "var(--ht-inverse-bg)", color: "var(--ht-inverse-fg)", borderRadius: "var(--ht-radius-md)",
      padding: "12px 16px", boxShadow: "var(--ht-shadow-md)", ...style }}>
