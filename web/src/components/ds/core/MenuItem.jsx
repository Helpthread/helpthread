...
export function MenuItem({ onClick, icon, shortcut, selected = false, destructive = false, children }) {
  ...
  return (
    <button type="button" onClick={onClick}
      style={{ display: "flex", alignItems: "center", gap: 10, width: "100%", boxSizing: "border-box",
        textAlign: "left", fontSize: 13, fontWeight: 600, color: fg,
        background: selected ? "var(--ht-accent-soft)" : "none", border: "none",
        borderRadius: "var(--ht-radius-sm)", padding: "7px 10px", cursor: "pointer" }}
      onMouseEnter={(e) => { e.currentTarget.style.background = destructive ? "var(--ht-critical-soft)" : "var(--ht-surface-2)"; }}
