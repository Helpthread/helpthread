      ...
      >
        {['S', 'M', 'T', 'W', 'T', 'F', 'S'].map((w, i) => (
          <span
            ...
            // and never reordered.
            // biome-ignore lint/suspicious/noArrayIndexKey: initials repeat; row is static
            key={`${w}-${i}`}
            style={{
              textAlign: 'center',
              fontSize: 10.5,
    ...
    >
      ...
      {!custom ? (
        ...
        <div style={{ padding: '12px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginTop: 12 }}>
            <span style={{ display: 'inline-flex', color: 'var(--ht-ink-dim)' }}>
              {IconClock(15)}
            </span>
            <input
              type="time"
      ...
      <div
        style={{
          ...
          alignItems: 'center',
          gap: 10,
          padding: custom ? '0 12px 12px' : '10px 12px',
      ...
      >
        <div style={{ flex: 1, fontSize: 12, color: 'var(--ht-ink-muted)', lineHeight: 1.35 }}>
          ...
          <span style={{ fontFamily: 'var(--ht-mono)', color: 'var(--ht-ink)' }}>
            {` · ${fmtTime(resolved)}`}
          </span>
        </div>
        {custom ? (
